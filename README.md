...
> 「サイバー戦争ごっこ」を本気で楽しむ、中学生の「わたしがかんがえたさいきょうのオリジナルカードゲーム」

**ちなみにルールやドキュメント、画像も含めて全部生成AIと壁打ちしながら作ってもらっています。**

**つまり、生成AIを相棒にして、どんだけのゲームができるのかという実験を兼ねています。**
...
ゲーム中では、本格的なサイバーパンクSFの世界観と、放課後の部活動というゆるい日常とのギャップを楽しめ…たらいいな。
...
ネットワークは国家の境界となり、
電子エージェントによる侵入戦争が日常となった世界。

攻撃プログラムを送り込み、
敵メインフレームを制圧することが勝利を意味する。

……という設定のカードゲームを、
カードゲーム部の三人は今日も真剣に遊んでいます。
...
* HTML5
* CSS3
* JavaScript (Vanilla JS)　←**しれっとChatGPTが出してきたｗ**
